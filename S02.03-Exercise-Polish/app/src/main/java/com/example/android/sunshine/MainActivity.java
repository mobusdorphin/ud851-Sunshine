...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        // NOT DONE (20) Call showWeatherDataView before executing the AsyncTask
        // Why show the view prior to gathering the data?  I would think it would be
        // preferable to clear the view instead, then display the appropriate view
        // when we know whether we're in an error state or not.
        clearView();
