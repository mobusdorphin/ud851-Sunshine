...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final int SUNSHINE_WEATHER_LOADER = 36;
    ...
    private void loadWeatherData() {
        ...
        weatherBundle.putString(USER_LOCATION, location);

        LoaderManager loaderManager = getLoaderManager();
        Loader<Object> sunshineLoader = loaderManager.getLoader(SUNSHINE_WEATHER_LOADER);
        loaderManager.restartLoader(SUNSHINE_WEATHER_LOADER, weatherBundle, this);
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                String location = args.getString(USER_LOCATION);
