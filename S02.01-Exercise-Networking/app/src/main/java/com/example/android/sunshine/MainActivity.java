...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadWeatherData(SunshinePreferences.getPreferredWeatherLocation(mWeatherTextView.getContext()));
    ...
    private void loadWeatherData(String s) {
        FetchWeatherTask fetchWeatherTask = new FetchWeatherTask();
        fetchWeatherTask.execute(NetworkUtils.buildUrl(s));
    }
