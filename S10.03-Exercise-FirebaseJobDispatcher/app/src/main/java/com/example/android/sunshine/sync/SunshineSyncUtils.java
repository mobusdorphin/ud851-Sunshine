...
//  DONE (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int SUNSHINE_SYNC_SECONDSS = (int) TimeUnit.SECONDS.toSeconds(SUNSHINE_SYNC_HOURS);
    private static final int SUNSHINE_TIME_INTERVAL = SUNSHINE_SYNC_SECONDSS / 3;

    private static boolean sInitialized;

//  DONE (11) Add a sync tag to identify our sync job
    private static final String  SUNSHINE_JOB_TAG = "sunshine-sync";

//  DONE (12) Create a method to schedule our periodic weather sync
    static void scheduleFirebaseJobSync(@NonNull Context context) {
        ...
        Job syncSunshineJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        SUNSHINE_SYNC_SECONDSS,
                        SUNSHINE_SYNC_SECONDSS + SUNSHINE_TIME_INTERVAL
                ))
